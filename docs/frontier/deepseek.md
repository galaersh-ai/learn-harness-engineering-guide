...
Связанные лекции: [Лекция 11 · Почему наблюдаемость belongs inside the harness](../lectures/lecture-12.md) ｜ [Лекция 12 · Почему каждая сессия must leave a clean state](../lectures/lecture-13.md) ｜ [Лекция 2 · Что такое харнес на самом деле](../lectures/02-what-a-harness-actually-is.md)
